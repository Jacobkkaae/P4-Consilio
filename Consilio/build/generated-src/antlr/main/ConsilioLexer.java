...
public class ConsilioLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"INT_LITERAL", "BOOLEAN_LITERAL", "IF", "INT", "BOOLEAN", "INITIALSTATE", 
			...
			"GE", "NOTEQUAL", "AND", "OR", "ADD", "SUB", "WS", "IDENTIFIER", "Digits", 
	...
	public ConsilioLexer(CharStream input) {
		super(input);
